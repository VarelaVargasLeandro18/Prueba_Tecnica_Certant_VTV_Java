 ...
 */
public class ModificacionInspeccionGUI implements IGUIAdapter {

    private InspeccionCRUD crud;
    private GUI gui;
    
    public ModificacionInspeccionGUI ( GUI gui ) {
    ...
    public void realizar() {
        ...
        try {
            ...
            Id = Long.valueOf( this.gui.leerString("Ingrese el Id de la Inspección a modificar") );
            inspeccion = this.crud.readOne(Id);
            
            if ( inspeccion == null ) {
                System.out.println("NO EXISTE LA INSPECCIÓN CON EL ID INDETIFICADO");
                return;
            }
            ...
            System.out.println( "SE HA PRODUCIDO UN ERROR AL ACTUALIZAR LA INSPECCIÓN. FIN DE LA OPERACIÓN." );
